  ...
  return (
    ...
    className='landing flex  flex-col items-center justify-around bg-gray-200'>
      <div className='flex flex-col justify-center bio z-20 '>
        <motion.h1 custom={1} variants={ textByXAnimation} className='landing__text text-5xl py-5 font-semibold text-center'>
          Некрашевич Марина Сергеевна
        </motion.h1>
        <motion.p custom={2} variants={ textByXAnimation} className='landing__subtext text-center text-l font-semibold text-gray-500 pb-5'>
        ...
        className='hover:transition-all flex justify-center items-end'>
          <li className='rounded landing__link landing__link_gmail mr-5 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-cyan-500 duration-300'>
            <a href='mailto:m.nekrashevich@denteria.ru' className='link' title="Почтовый ящик"> </a>
          </li>
          ...
          <li className='rounded landing__link landing__link_vk transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-cyan-500 duration-300'>
            <a href='https://m.vk.com/meowwzilla' className='link' target='_blank' rel="noreferrer" title="VKontakte"> </a>
          </li>
        </motion.ul>
      </div>

      <motion.div className='figure bg-gradient-to-r from-gray-200 to-cyan-500 z-10 rounded'
      animate={{rotate: 360}}
